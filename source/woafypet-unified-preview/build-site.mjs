...
const ASSET_VERSION = "20260825.2";
...
function wmHomePage() {
  ...
  return page({
    ...
    <div class="home-reference">
      ...
      <section class="home-platform-model" aria-labelledby="home-platform-heading"><header><span>THE PLATFORM</span><h2 id="home-platform-heading">Care that starts with your dog.</h2></header><div><article><h3>What it does</h3><p>WoafMeow turns changes you notice at home into tailored care lessons, trackable records and clearer veterinary conversations.</p></article><article><h3>Why it is different</h3><p>Every lesson starts with a real owner’s question and the dog’s age, breed, conditions and routine—not a generic pet article.</p></article><article><h3>How we make money</h3><p>Public guidance is free. Revenue comes from WoafyPet products and optional paid care tools for saved histories, alerts and vet-ready reports.</p></article></div></section>
      ...
      <section class="home-ref-bed" aria-labelledby="home-bed-heading"><header><span>WoafyPet Smart Bed</span><h2 id="home-bed-heading"><span>Support stiff joints.</span> <span>Spot possible pain changes.</span></h2><p>Orthopedic cushioning lowers pressure at rest. Smart Base tracks changes in rest, nighttime movement, bed use and weight—evidence owners can take to a veterinarian when discomfort may be hiding.</p></header><div class="home-bed-grid">
        <article class="home-bed-story home-bed-comfort-story"><div class="home-bed-copy"><span>Orthopedic support + pain awareness</span><h3><span>Reduce pressure.</span> <span>Spot comfort changes.</span></h3><p>A low entry and stable bolsters make settling easier for stiff dogs. Smart Base adds rest, movement, bed-use and weight patterns that can strengthen a veterinary pain conversation.</p><ul class="home-bed-feature-list"><li><strong>Lower-effort entry</strong><span>Less strain when stepping in or out</span></li><li><strong>Pressure-relieving foam</strong><span>Cushions joints and high-pressure areas</span></li><li><strong>Stable bolsters</strong><span>Support for turning, leaning and rising</span></li><li><strong>Possible pain signals</strong><span>Pattern changes worth reviewing with a veterinarian</span></li></ul><a class="button primary" href="https://www.woafy.pet/">Explore orthopedic support and Smart Base →</a></div><figure>${image("product-prototype-golden.webp", "Golden retriever resting in the current rectangular WoafyPet Smart Bed")}</figure></article>
        <article class="home-bed-story home-bed-layer-story"><figure class="home-bed-layer-figure">${image("bed-layers.png", "Complete WoafyPet Smart Bed foam and Smart Base layer system")}<b class="home-bed-fifth-marker" aria-label="Layer 5">5</b></figure><div class="home-bed-copy"><span>Five purposeful layers</span><h3><span>Five layers.</span> <span>Steadier rest.</span></h3><p>Each layer solves a care problem: washable comfort, pressure relief, stable orthopedic support, passive pattern tracking and a base that stays put.</p><ol class="home-bed-layer-list"><li><b>1</b><span><strong>Soft removable cover</strong>Machine-washable everyday care</span></li><li><b>2</b><span><strong>Comfort foam</strong>Relieves surface pressure</span></li><li><b>3</b><span><strong>Orthopedic support</strong>Stable, medical-grade foam</span></li><li><b>4</b><span><strong>Smart Base</strong>Passive rest and weight sensing</span></li><li><b>5</b><span><strong>Non-slip base</strong>Stays steady during entry</span></li></ol><a class="button secondary" href="https://www.woafy.pet/">See the complete bed →</a></div></article>
        <article class="home-bed-story home-bed-tracking-story"><div class="home-bed-copy"><span>Smart Base pattern tracking</span><h3><span>Track rest changes.</span> <span>Flag discomfort changes.</span></h3><p>No collar and no camera. Smart Base organizes repeated patterns so changes linked to comfort, mobility or possible pain are easier to document over time.</p><div class="home-bed-metrics"><span><b>Rest duration</b>See whether total rest is shifting</span><span><b>Night movement</b>Notice wake-ups and repositioning</span><span><b>Bed use</b>Spot avoidance of a familiar rest place</span><span><b>Weight trends</b>Add longer-term context for your care team</span></div><a class="button primary" href="https://www.woafy.pet/">See how Smart Base tracks change →</a></div><figure>${image("product-visualization-smart-base.png", "WoafyPet Smart Base passive rest, movement and weight pattern system")}</figure></article>
      </div></section>
