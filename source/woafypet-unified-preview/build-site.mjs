...
function footer() {
  return `<footer class="wm-footer">
    <div class="wm-footer-grid">
      <div class="wm-footer-brand"><a class="wm-wordmark" data-logo-mark href="/" aria-label="WoafMeow home"><span class="sr-only">WoafMeow</span></a><p>Learn, connect and find support—so your dog's senior years can thrive.</p><strong class="wm-footer-trust">Trusted by 10,000+ pet owners.</strong></div>
      ...
      <div><h2>Find Care</h2><a href="/find-care/">In-home care</a><a href="/find-care/?care=senior-veterinarians">Veterinarians</a><a href="/find-care/?care=pain-mobility-rehab">Specialists</a></div>
...
function wmHomePage() {
  ...
  return page({
    ...
    <div class="home-reference">
      ...
      <section class="home-care-circle" aria-labelledby="home-circle-heading"><div class="home-circle-lessons"><header><div><h2 id="home-circle-heading">Real questions. Practical answers you can use today.</h2><p>Public Care Circle lessons shaped around the details dog parents share.</p></div><a href="/care-circle/">Explore more lessons →</a></header><div class="home-circle-grid">${publicLessons.map(([topic, title, copy, asset, href]) => `<a class="home-circle-card" href="${href}"><figure>${image(asset, `${topic.toLowerCase()} public Care Circle lesson`)}</figure><div><small>${topic}</small><h3>${title}</h3><p>${copy}</p><span>Read lesson →</span></div></a>`).join("")}</div></div><aside class="home-circle-ask"><h2>Ask Care Circle.</h2><p>Tell us what changed. We’ll connect your question to the right lesson, then use your dog’s profile to make the guidance more relevant.</p><form data-home-question-form><label for="home-circle-question">Your question</label><textarea id="home-circle-question" name="question" maxlength="500" placeholder="What are you noticing with your dog?" required></textarea><button class="button primary" type="submit">Ask now →</button></form><div class="home-circle-trust"><strong>10,000+ pet owners</strong><span>Veterinarian-supported lessons</span><span>Real conditions shared with consent</span></div></aside></section>

      <section class="home-ref-guide"><div><h2>The complete Senior Dog Care Guide—free.</h2><p>Movement, sleep, eating, drinking, bathroom changes and daily comfort in one clear guide.</p></div><form data-preview-form data-guide-delivery data-submit-api="https://www.woafmeow.com/api/newsletter" data-success-message="The guide is on its way. Please check your inbox and spam folder." data-form-title="Senior Dog Care Guide"><input type="hidden" name="requestType" value="senior-dog-guide"><input type="hidden" name="guideUrl" value="https://labian1.github.io/guide/"><input type="hidden" name="consent" value="true"><label><span class="sr-only">Email address</span><input name="email" type="email" autocomplete="email" placeholder="Your email address" required></label><button class="button primary" type="submit">Send me the guide →</button><p class="form-note" data-form-note role="status" aria-live="polite"></p></form><a class="home-guide-book" href="/guide/" aria-label="Explore the complete Senior Dog Care Guide"><span>The complete</span><strong>Senior Dog<br>Care Guide</strong>${image("real-golden-forest.jpg", "Golden retriever on the cover of the Senior Dog Care Guide")}</a></section>
...
function wmWednesdayPage() {
  return page({
    ...
    <section class="match-how"><div class="wm-wrap image-text"><figure>${image("real-companion-moment.jpg", "Two people and a dog spending time together outdoors")}</figure><div><h2>One thoughtful introduction at a time.</h2><ol><li><span>1</span><div><strong>Tell us what is happening</strong><p>Share the care issue and the conversation you need.</p></div></li><li><span>2</span><div><strong>We look for the closest fit</strong><p>Issue, location, schedule and preferred first contact matter.</p></div></li><li><span>3</span><div><strong>Both people choose</strong><p>Start with a call, coffee or calm public walk.</p></div></li></ol></div></div></section>
    <section class="match-issues"><div class="wm-wrap">${editorialHeading("Find someone living through something similar", "A useful introduction begins with the part of daily care that feels hardest.")}<div>${[
      ...
      .join("")}</div></div></section>
    <section class="match-form-section" id="introduction-request"><div class="wm-wrap"><div><h2>Who would help you feel understood?</h2><p>Share enough to recognize a meaningful fit.</p></div><form class="match-form-v6 preview-form" data-preview-form data-submit-api="https://www.woafmeow.com/api/contact" data-success-message="Your introduction request is with the WoafMeow team." data-form-title="Wednesday introduction"><input type="hidden" name="topic" value="wednesday-match"><div class="form-grid"><label><span>Name</span><input name="name" autocomplete="name" required></label><label><span>Email</span><input name="email" type="email" autocomplete="email" required></label><label><span>ZIP or postal code</span><input name="zip" autocomplete="postal-code" required></label><label><span>Your dog's age</span><select name="dogAge" required><option value="">Choose one</option><option>Under 1 year</option><option>1–3 years</option><option>4–6 years</option><option>7–9 years</option><option>10–12 years</option><option>13–15 years</option><option>16+ years</option></select></label><label><span>What are you navigating?</span><select name="issue" required><option value="">Choose one</option><option>Mobility or stiffness</option><option>Restless nights</option><option>Eating, drinking or weight</option><option>Bathroom changes</option><option>Daily care or connection</option><option>Other</option></select></label><label><span>How would you like to begin?</span><select name="contact" required><option value="">Choose one</option><option>Owner-only phone call</option><option>Coffee in a public place</option><option>Calm public walk</option><option>Open to any</option></select></label><label class="field-wide"><span>What would make the conversation useful?</span><textarea name="message" maxlength="500" required></textarea></label></div><label class="consent-row"><input type="checkbox" name="consent" required><span>I agree to be contacted about a possible introduction.</span></label><button class="button primary" type="submit">Request my introduction →</button><p class="form-note" data-form-note role="status" aria-live="polite"></p></form></div></section>
