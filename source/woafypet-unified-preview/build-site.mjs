...
function wmAboutPage() {
  return page({
    ...
    bodyClass: "about-v6",
    body: `
    <section class="bobby-hero"><figure>${image("bobby.jpg", "Bobby, the Alaskan Malamute whose life inspired WoafMeow", { eager: true })}</figure><div><span>A NOTE FROM BOBBY</span><h1>I was Bobby. This is why WoafMeow exists.</h1><p>I was a big Alaskan Malamute who loved my family, bright afternoons and being close to my people. Even when my body began to slow down, I was still me.</p><p class="bobby-signoff">Love,<br><strong>Bobby</strong></p></div></section>
    <section class="bobby-letter"><div class="reading-width"><p class="drop-cap">I could not tell my family that getting up was becoming harder. I could not explain why I chose the cool floor, why I needed longer to settle, or why a good day sometimes took more out of me than it used to.</p><p>The changes arrived quietly. One slower rise. One longer recovery. One more night spent shifting until I felt comfortable. Each moment was small enough to explain away, especially because I still greeted the people I loved and found my familiar way of asking to be near them.</p><blockquote>My family loved me completely. What they needed was a clearer way to hear the things I could only say through my routine.</blockquote><p>That is why they began building WoafMeow: not because love was missing, but because love deserves help noticing. A dog should not have to become visibly unwell before a family feels allowed to pay attention.</p><p>And that is why WoafyPet begins with rest. I needed a bed that supported my aging body first, with quiet technology that could help my family recognize repeated changes without pretending to diagnose me.</p><p>If my story helps one family notice sooner, ask a better question, find the right person, or make one ordinary day gentler for their dog, then the things I could not say out loud still mattered.</p></div></section>
    <section class="bobby-purpose"><div class="wm-wrap"><header><span>OUR MISSION · HOW WE HELP</span><h2>Help families hear what their dogs are already telling them.</h2><p>WoafMeow turns quiet changes into understanding, support and a kinder next step—so dogs can be cared for as whole lives, not symptoms.</p></header><div><article><strong>01</strong><h3>Notice with less fear</h3><p>Turn “something feels different” into a clear observation and a useful question for your care team.</p></article><article><strong>02</strong><h3>Find someone who understands</h3><p>Reach professional care, practical resources and another owner who has lived this kind of day.</p></article><article><strong>03</strong><h3>Honor the whole bond</h3><p>Support comfort, connection, goodbye and remembrance without turning vulnerable moments into sales pressure.</p></article></div><a class="button primary" href="/care-circle/">See how Bobby’s story helps today →</a></div></section>
    <section class="bobby-closing"><p>I could not have asked for a better family.<br>Thank you for letting my story care for yours.</p><a class="text-link" href="/support/">Tell us about your dog →</a></section>`,
  });
}
