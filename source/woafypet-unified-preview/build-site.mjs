...
function page({ route, title, description, body, bodyClass = "" }) {
  ...
  const runtimeBody = body.replaceAll(
    ...
    "https://woafypet-senior-care.pages.dev/api/",
  );
  ...
  return page({
    ...
    <div class="home-reference">
      ...
      <section class="home-ref-bed" aria-labelledby="home-bed-heading"><header><span>WoafyPet Smart Bed</span><h2 id="home-bed-heading"><span>Support stiff joints.</span> <span>Track possible pain changes.</span></h2><p>Orthopedic foam reduces pressure. Smart Base tracks rest, movement, bed use and weight changes.</p></header><div class="home-bed-grid">
        ...
        <article class="home-bed-story home-bed-tracking-story"><div class="home-bed-copy"><span>Smart Base tracking</span><h3><span>Track rest.</span> <span>Flag discomfort.</span></h3><p>No collar or camera. Review changes worth sharing with your veterinarian.</p><div class="home-bed-metrics"><span><b>Rest</b>Total duration</span><span><b>Night</b>Wake-ups</span><span><b>Bed use</b>Avoidance</span><span><b>Weight</b>Longer trends</span></div><a class="button primary" href="https://www.woafy.pet/">Explore Smart Base →</a></div><figure>${image("product-visualization-smart-base.png", "WoafyPet Smart Base passive rest, movement and weight pattern system")}</figure></article>
      </div></section>
...
function wmHomePage() {
  ...
  return page({
    ...
    <div class="home-contract">
      ...
      <section class="home-contract-care-grid" aria-label="Veterinary evidence"><article class="home-contract-evidence"><figure>${image("vet-silvan-urfer.jpg", "Silvan R. Urfer, veterinarian and dog-aging researcher")}</figure><div><span class="home-kicker">VETERINARY EVIDENCE</span><h2>Care rooted in veterinary knowledge.</h2><p>Our guidance is shaped by veterinary expertise, so you can feel more confident in the next step you take.</p><p class="home-vet-credential"><strong>Silvan R. Urfer, Dr. med. vet.</strong><span>Veterinarian and dog-aging researcher · Dog Aging Project</span></p><a href="/find-care/?care=senior-veterinarians">Find veterinary care →</a></div></article></section>
      ...
      <section class="home-contract-bed" aria-labelledby="home-bed-title">
        <div class="home-bed-system">
          <div class="home-contract-bed-copy"><span class="home-kicker">COMPLETE ORTHOPEDIC SYSTEM</span><h2 id="home-bed-title">Support stiff joints. See change sooner.</h2><p class="home-bed-lead">The low-entry bed supports easier settling and rising. The Smart Base quietly records rest, night movement, bed use and weight—so a sustained shift is easier to see and share with your veterinarian.</p><ul class="home-bed-results"><li><strong>Less effort getting in</strong><span>A low front opening reduces the step for stiff or slower legs.</span></li><li><strong>Support without deep sinking</strong><span>Stable orthopedic layers spread pressure and support easier turning.</span></li><li><strong>Comfort where they lean</strong><span>Structured bolsters support the head, neck and hips.</span></li><li><strong>Care you can keep up</strong><span>Remove and wash the cover without replacing the support system.</span></li></ul><a class="button primary" href="https://www.woafy.pet/">Explore Bed + Smart Base →</a></div>
          <figure class="home-contract-complete">${image("bed-smart-base-system-branded.png", "Complete cream WoafyPet orthopedic bed with low front opening beside the separate dark Smart Base")}<figcaption><span>WoafyPet orthopedic bed</span><span>Smart Base</span></figcaption></figure>
        </div>
        <div class="home-bed-construction">
          <div class="home-bed-construction-copy"><span class="home-kicker">FIVE WORKING LAYERS</span><h3>Five layers with five clear jobs.</h3><p>From easier entry to pressure relief and tracking, nothing is there just to add height.</p></div>
          <figure class="home-contract-product">${image("bed-layers.png", "Exploded WoafyPet Bed and Smart Base showing five numbered construction layers")}<b class="home-bed-fifth-marker" aria-label="Layer 5">5</b></figure>
          <aside class="home-bed-proof" aria-label="Five WoafyPet Bed and Smart Base layers"><div><span aria-hidden="true">1</span><p><strong>Low-entry washable shell</strong>Easier step-in and faster daily cleanup</p></div><div><span aria-hidden="true">2</span><p><strong>Supportive bolster foam</strong>Steady support for the head, neck and hips</p></div><div><span aria-hidden="true">3</span><p><strong>Pressure-relief layer</strong>Cushions sensitive joints and spreads pressure</p></div><div><span aria-hidden="true">4</span><p><strong>Stable orthopedic core</strong>Supports turning without deep sinking</p></div><div><span aria-hidden="true">5</span><p><strong>Smart Base</strong>Tracks rest, night movement, bed use and weight</p></div></aside>
        </div>
      </section>

      <section class="home-contract-close" aria-label="Smart Base insights and care profile"><article class="home-contract-insights"><figure>${image("product-visualization-smart-base.png", "Verified dark WoafyPet Smart Base shown flat and folded for passive pattern tracking")}</figure><div><span class="home-kicker">EARLIER CHANGE SIGNALS</span><h2>See meaningful changes sooner.</h2><p>Smart Base compares each day with your dog’s own baseline. When rest, movement, bed use or weight shifts and stays changed, you have evidence to watch closer and share with your veterinarian.</p><dl class="home-insight-metrics"><div><dt>Broken or shorter rest</dt><dd>May accompany discomfort, breathing trouble or illness.</dd></div><div><dt>More night movement</dt><dd>May point to pain, confusion or bathroom needs.</dd></div><div><dt>Less frequent bed use</dt><dd>May reveal harder entry, pressure or reduced mobility.</dd></div><div><dt>Weight gain or loss</dt><dd>Can accompany appetite, activity or chronic-disease change.</dd></div></dl><p class="home-insight-action"><strong>Act on the pattern:</strong> Save a sustained shift to your dog’s timeline and bring it to your veterinarian.</p><small>Smart Base flags patterns. It does not diagnose pain or disease.</small><a href="/smart-base/">See how early-change tracking works →</a></div></article><article class="home-contract-profile"><div><span aria-hidden="true">♡</span><p><strong>Build your dog’s care profile</strong>Add your dog once. Keep private lessons and health history together.</p></div><a href="/account/">Create my care profile →</a></article></section>
...
function wmFindCarePage() {
  ...
  return page({
    ...
    body: `
    <section class="directory-hero-v6"><div><h1>Find the right care.</h1><p>Choose the kind of help and your region. Each listing opens a provider-published profile or official professional directory.</p><div class="directory-selectors" data-directory-controls><label><span>Care type</span><select data-directory-category>${careTypes.map(([value, label]) => `<option value="${value}">${label}</option>`).join("")}</select></label><label><span>State or region</span><select data-directory-region><option value="all">All states and regions</option>${regions.map((region) => `<option value="${escapeHtml(region)}">${escapeHtml(region)}</option>`).join("")}</select></label></div></div><figure>${image("guide-vet-care-brown-dog.jpg", "Real dog receiving attentive veterinary care", { eager: true })}</figure></section>
...
function wmMemorialPage() {
  return page({
    ...
    body: `
    <section class="memorial-hero-v6"><figure>${image("real-memorial-tree-planting.jpg", "Hands planting a young memorial tree", { eager: true })}</figure><div><h1>Let their love take root.</h1><p>A tree planted in your dog's name becomes a living act of remembrance—something growing in the world because they were here.</p><button class="button primary" type="button" data-tree-purchase-open>Plant a tree in their name →</button></div></section>
    <section class="memorial-meaning"><div class="wm-wrap"><div><h2>Carry their life forward.</h2><p>Tell us the name you still say, the moment you never want to lose and the message this tree should carry. That story becomes part of the planting record you keep.</p><strong class="memorial-words-label">Words you can use</strong><p class="memorial-wording">You changed our home, our routines and the way we understood love. Let something beautiful keep growing in your name.</p></div><figure>${image("real-companion-moment.jpg", "A quiet moment between a caregiver and a beloved dog")}</figure></div></section>
    <section class="memorial-story-grid"><div class="wm-wrap"><header><h2>For the dog who changed you.</h2><p>The bowl may be gone. The familiar route may feel too quiet. Planting a tree gives that love a living place to continue.</p></header><div><article><figure>${image("bobby.jpg", "Bobby, a beloved dog remembered by WoafMeow")}</figure><h3>Carry their name</h3><p>The planting is requested in your dog's name, so the tribute begins with who they were to you.</p></article><article><figure>${image("real-holding-dog.jpg", "A dog owner holding a beloved companion close")}</figure><h3>Keep one memory close</h3><p>Write the moment, habit or feeling you never want to lose. That message stays with your memorial record.</p></article><article><figure>${image("real-golden-outdoors.jpg", "A dog outdoors in a place filled with life")}</figure><h3>Help something living grow</h3><p>Your tribute supports a community-grown tree in the West Usambara Mountains.</p></article></div></div></section>
    <section class="memorial-memory-prompts"><div class="wm-wrap"><header><h2>Begin with the moment that still feels like them.</h2><p>A memorial becomes personal when it carries a detail only your family would know.</p></header><div><p>The way you waited at the window before every walk.</p><p>The warm spot beside the sofa that will always feel like yours.</p><p>How one look from you made an ordinary day feel complete.</p></div></div></section>
    <section class="memorial-partner"><div class="wm-wrap"><header><h2>Community-grown. Clearly documented.</h2><p>Friends of Usambara works with local nurseries, schools, farmers and communities in the West Usambara Mountains, while publishing a broader goal to support other Eastern Arc landscapes and East Africa.</p></header><div class="memorial-partner-gallery"><figure>${image("usambara-community-planting.jpg", "Friends of Usambara community members planting trees")}</figure><figure>${image("usambara-sapling-planting.jpg", "Hands planting a young tree with Friends of Usambara")}</figure><figure>${image("usambara-school-nursery.jpg", "Students participating in a Friends of Usambara tree nursery")}</figure><figure>${image("usambara-mangrove-planting.jpg", "Community planting work supported by Friends of Usambara")}</figure></div><div class="partner-proof-grid"><article><strong>15 million+</strong><span>Seedlings stocked across four mega nurseries, reported by the partner</span></article><article><strong>4 mega nurseries</strong><span>Locally grown seedlings for restoration</span></article><article><strong>20 school nurseries</strong><span>Young people helping trees take root</span></article></div><a class="text-link" href="https://usambaratravels.com/where-we-plant/" target="_blank" rel="noreferrer">See Friends of Usambara’s planting work →</a></div></section>
    <section class="memorial-steps"><div class="wm-wrap"><div class="memorial-tribute-card"><span>Example tribute</span><h2>Bailey</h2><p>You made every ordinary walk feel like the best part of the day.</p><div>${image("real-golden-forest.jpg", "Golden retriever remembered with a living tree tribute")}</div></div><div class="memorial-steps-copy"><h2>Their memory. A growing tree.</h2><p>Share the words you never want to lose. We connect that memory to a community-grown tree and send a memorial confirmation you can keep or share with family.</p><ol><li><span>1</span><div><strong>Tell us their name</strong><p>Add one story, habit or sentence that still feels like them.</p></div></li><li><span>2</span><div><strong>Complete secure payment</strong><p>Stripe collects the $10 payment; no card details are stored by WoafMeow.</p></div></li><li><span>3</span><div><strong>Keep the confirmation</strong><p>After Stripe confirms payment, we email a memorial record carrying their name and your message.</p></div></li></ol><button class="button primary" type="button" data-tree-purchase-open>Plant their memorial tree →</button><p class="memorial-checkout-status" data-checkout-status role="status" aria-live="polite"></p></div></div></section>
    <dialog class="tree-purchase-dialog" data-tree-purchase><button type="button" class="tree-dialog-close" data-tree-purchase-close aria-label="Close">×</button><div><h2>Plant their memorial tree</h2><p class="tree-price">$10 per tree</p><form class="preview-form" data-preview-form data-checkout-form data-submit-api="https://woafypet-senior-care.pages.dev/api/memorial-tree-checkout" data-form-title="Memorial tree checkout"><div class="form-grid"><label><span>Your name</span><input name="name" autocomplete="name" required minlength="2" maxlength="100"></label><label><span>Email</span><input name="email" type="email" autocomplete="email" required maxlength="254"></label><label><span>Your dog's name</span><input name="petName" required minlength="1" maxlength="80"></label><label class="field-wide"><span>One memory to carry forward</span><textarea name="meaning" required minlength="12" maxlength="600"></textarea></label></div><button class="button primary" type="submit">Continue to secure payment — $10 →</button><p class="form-note" data-form-note role="status" aria-live="polite"></p></form></div></dialog>`,
  });
}
...
function wmSmartBedPage() {
  return page({
    ...
    <section class="bed-insights-v6"><div class="wm-wrap"><div><h2>Track rest. Flag discomfort.</h2><p>No collar or camera.</p><div class="metric-grid"><article><span>Rest</span><strong>Total duration</strong></article><article><span>Night</span><strong>Wake-ups</strong></article><article><span>Bed use</span><strong>Avoidance</strong></article><article><span>Weight</span><strong>Longer trends</strong></article></div>${button("Explore Smart Base", "/smart-base/")}</div><figure>${image("product-visualization-smart-base.png", "WoafyPet Smart Base passive wellness insight system")}</figure></div></section>
...
function wmSmartBasePage() {
  return page({
    ...
    bodyClass: "base-v6",
    body: `
    <section class="base-hero-v6"><div><span>WoafyPet Smart Base</span><h1>Track rest without another wearable.</h1><p>The sensing layer sits beneath the bed and turns repeated use into a calmer weekly view.</p>${button("Explore the complete bed", "/smart-bed/")}</div><figure>${image("product-visualization-smart-base.png", "WoafyPet Smart Base product visualization", { eager: true })}</figure></section>
