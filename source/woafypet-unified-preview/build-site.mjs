...
function wmSmartBedPage() {
  return page({
    ...
    <section class="bed-insights-v6"><div class="wm-wrap"><div><h2>Track rest. Flag discomfort.</h2><p>No collar or camera.</p><div class="metric-grid"><article><span>Rest</span><strong>Total duration</strong></article><article><span>Night</span><strong>Wake-ups</strong></article><article><span>Heart rate</span><strong>Resting trend</strong></article><article><span>Weight</span><strong>Longer trends</strong></article></div>${button("Explore Smart Base", "/smart-base/")}</div><figure>${image("product-visualization-smart-base.png", "WoafyPet Smart Base passive wellness insight system")}</figure></div></section>
