    ...
    <div class="home-contract">
      ...
      <section class="home-contract-bed" aria-labelledby="home-bed-title">
        <div class="home-bed-system">
          <div class="home-contract-bed-copy"><span class="home-kicker">ORTHOPEDIC BED + SMART BASE</span><h2 id="home-bed-title">Better rest. Earlier health alerts.</h2><p class="home-bed-lead">The bed supports stiff joints. Smart Base alerts you when rest, movement, bed use or weight shifts from your dog’s normal pattern.</p><ul class="home-bed-results"><li><strong>Easier entry</strong><span>Low front edge for stiff legs.</span></li><li><strong>Joint pressure relief</strong><span>Firm orthopedic foam supports turning and rising.</span></li><li><strong>Easy cleanup</strong><span>Scratch-resistant cover removes for machine washing.</span></li></ul><a class="button primary" href="https://www.woafy.pet/">Explore Bed + Smart Base →</a></div>
