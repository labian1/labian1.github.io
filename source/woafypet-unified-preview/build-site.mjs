    ...
    <div class="home-contract">
      ...
      <section class="home-contract-bed" aria-labelledby="home-bed-title">
        <div class="home-bed-system">
          <div class="home-contract-bed-copy"><span class="home-kicker">ORTHOPEDIC BED + SMART BASE</span><h2 id="home-bed-title">Better rest. Earlier health alerts.</h2><p class="home-bed-lead">The orthopedic bed reduces pressure on stiff joints. Smart Base alerts you when sleep, movement, bed use or weight shifts from your dog’s normal pattern.</p><ul class="home-bed-results"><li><strong>Easier entry</strong><span>Low front edge reduces the step for stiff legs.</span></li><li><strong>Pressure relief</strong><span>Orthopedic foam cushions joints without deep sinking.</span></li><li><strong>Simple cleanup</strong><span>Scratch-resistant cover removes for machine washing.</span></li></ul><a class="button primary" href="https://www.woafy.pet/">Explore Bed + Smart Base →</a></div>
          <figure class="home-contract-complete"><div class="home-bed-lifestyle">${image("product-prototype-golden-full-v2.png", "Golden retriever resting in the complete WoafyPet orthopedic bed on its Smart Base")}</div><figcaption class="home-bed-pair-card">${image("bed-smart-base-system-branded.png", "Full WoafyPet orthopedic bed and full Smart Base shown side by side")}<strong>Full orthopedic bed + Smart Base</strong></figcaption></figure>
        </div>
