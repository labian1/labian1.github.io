...
const ASSET_VERSION = "20260825.1";
...
function wmHomePage() {
  ...
  return page({
    ...
    <div class="home-reference">
      <section class="home-ref-hero"><div class="home-ref-hero-copy"><span class="home-hero-eyebrow">Senior-dog care, made clearer</span><h1>Know what your aging dog needs next.</h1><p>Describe the change you see. Care Circle turns it into practical observations, safer next steps and a clearer conversation with your veterinarian.</p><form class="home-hero-chat" action="/care-circle/" method="get" aria-label="Ask Care Circle about a change in your dog"><label for="home-care-question"><span>What changed with your dog?</span><span class="home-chat-status">Private until you choose otherwise</span></label><div><input id="home-care-question" name="q" type="search" maxlength="500" required placeholder="e.g., slower after rest, waking at night, eating less"><input name="ask" type="hidden" value="1"><button class="button primary" type="submit">Ask Care Circle →</button></div><p>Educational guidance—not a diagnosis. Urgent changes still need veterinary care.</p></form></div><figure>${image("problem-mobility-senior-lab.jpg", "Senior Labrador resting comfortably at home", { eager: true })}</figure></section>
      <section class="home-trust-proof" aria-label="Why dog parents trust WoafMeow"><article><span aria-hidden="true">10K+</span><div><strong>Trusted by 10,000+ pet owners</strong><p>Real questions, real dogs and practical care tools.</p></div></article><article><span aria-hidden="true">DVM</span><div><strong>Veterinarian-supported</strong><p>Guidance shaped by veterinary knowledge and published expertise.</p></div></article><article><span aria-hidden="true">♥</span><div><strong>Built for dog parents</strong><p>Clear next steps for the people who know their dogs best.</p></div></article></section>
