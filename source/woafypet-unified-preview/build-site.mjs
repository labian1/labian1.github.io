...
const ASSET_VERSION = "20260827.9";
...
function homePage() {
  ...
  return page({
    ...
    <section class="bed-v6-insights"><figure>${image("bed-layers.png", "WoafyPet Smart Bed layers with the Smart Base beneath the comfort system")}</figure><div class="bed-v6-copy"><h2>Know when their rest begins to change.</h2><p>The Smart Base turns ordinary nights into four simple trends—without a collar or camera.</p><div class="tracking-result-grid"><article><strong>Rest duration</strong><span>Is total rest becoming shorter?</span></article><article><strong>Night movement</strong><span>Are interruptions becoming more frequent?</span></article><article><strong>Bed use</strong><span>Is a familiar sleep space being used less?</span></article><article><strong>Weight trend</strong><span>Is gradual change worth discussing sooner?</span></article></div><div class="bed-v6-result">See the pattern. Save the timeline. Ask a better veterinary question.</div>${button("Explore the WoafyPet Smart Bed", "/smart-bed/")}</div></section>
...
function wmSmartBedPage() {
  return page({
    ...
    body: `
    <section class="bed-hero-v6"><div><span>WoafyPet Smart Bed</span><h1>Support stiff joints. Track rest changes.</h1><p>Orthopedic comfort with quiet Smart Base tracking.</p>${button("Explore Bed + Smart Base", "/smart-bed/")}</div><figure class="bed-system-media"><div>${image("product-hero-official.png", "Complete WoafyPet Smart Bed resting on its Smart Base", { eager: true })}<strong>Full Smart Bed</strong></div><div>${image("smart-base.webp", "WoafyPet Smart Base shown separately", { eager: true })}<strong>Smart Base</strong></div></figure></section>
