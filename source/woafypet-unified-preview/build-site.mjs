...
function wmHomePage() {
  ...
  return page({
    ...
    <div class="home-contract">
      ...
      <section class="home-contract-bed" aria-labelledby="home-bed-title"><div class="home-contract-bed-copy"><span class="home-kicker">BED + SMART BASE</span><h2 id="home-bed-title">Support stiff joints. Spot change sooner.</h2><p>Low-entry orthopedic layers support easier rest and movement now. The Smart Base follows changes that may deserve a closer look.</p><a class="button primary" href="https://www.woafy.pet/">Explore Bed + Smart Base →</a></div><figure class="home-contract-product">${image("bed-layers.png", "Exploded WoafyPet Bed and Smart Base with five numbered construction layers")}<b class="home-bed-fifth-marker" aria-label="Layer 5">5</b></figure><aside class="home-bed-proof" aria-label="Five WoafyPet Bed and Smart Base layers"><div><span aria-hidden="true">1</span><p><strong>Low-entry washable shell</strong>Easier step-in and faster daily cleanup</p></div><div><span aria-hidden="true">2</span><p><strong>Supportive bolster foam</strong>A steady edge for head, neck and hips</p></div><div><span aria-hidden="true">3</span><p><strong>Pressure-relief layer</strong>Cushions sensitive joints and spreads pressure</p></div><div><span aria-hidden="true">4</span><p><strong>Stable orthopedic core</strong>Supports easier turning without deep sinking</p></div><div><span aria-hidden="true">5</span><p><strong>Smart Base</strong>Tracks rest, movement, bed use and weight change</p></div></aside></section>

      <section class="home-contract-close" aria-label="Smart Base insights and care profile"><article class="home-contract-insights"><figure>${image("product-visualization-smart-base.png", "Verified WoafyPet Smart Base for passive rest, movement, bed-use and weight tracking")}</figure><div><span class="home-kicker">EARLIER CHANGE SIGNALS</span><h2>Spot health changes sooner.</h2><p>Smart Base compares four daily signals with your dog’s usual pattern, helping you see when a sustained shift deserves attention.</p><dl class="home-insight-metrics"><div><dt>Rest duration</dt><dd>Shorter or broken rest can point to discomfort, breathing trouble or illness.</dd></div><div><dt>Night-movement pattern</dt><dd>More pacing or repositioning can signal pain, confusion or bathroom needs.</dd></div><div><dt>Bed-use frequency</dt><dd>Avoiding the bed can reveal harder entry, pressure or a mobility change.</dd></div><div><dt>Weight trend</dt><dd>Gradual gain or loss can accompany appetite, activity or chronic-disease change.</dd></div></dl><p class="home-insight-action"><strong>What to do:</strong> Add a sustained shift to your dog’s timeline and share it with your veterinarian.</p><small>Smart Base flags changes from normal. It does not diagnose pain or disease.</small><a href="/smart-base/">See how early-change tracking works →</a></div></article><article class="home-contract-profile"><div><span aria-hidden="true">♡</span><p><strong>Build your dog’s care profile</strong>Add your dog once. Keep private lessons and health history together.</p></div><a href="/account/">Create my care profile →</a></article></section>
