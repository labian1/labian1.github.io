    ...
    <div class="home-contract">
      ...
      <section class="home-contract-bed" aria-labelledby="home-bed-title">
        <div class="home-bed-system">
          <div class="home-contract-bed-copy"><span class="home-kicker">ORTHOPEDIC BED + SMART BASE</span><h2 id="home-bed-title">Support stiff joints. Spot change sooner.</h2><p class="home-bed-lead">Low-entry support makes rest easier. Smart Base tracks changes worth sharing with your veterinarian.</p><ul class="home-bed-results"><li><strong>Easier entry</strong><span>Low front for stiff legs.</span></li><li><strong>Stable support</strong><span>Firm layers help them turn.</span></li><li><strong>Earlier signals</strong><span>Track rest, movement, bed use and weight.</span></li></ul><a class="button primary" href="https://www.woafy.pet/">Explore Bed + Smart Base →</a></div>
          <figure class="home-contract-complete">${image("product-prototype-golden.webp", "Golden retriever resting in the branded WoafyPet orthopedic bed on its Smart Base")}</figure>
        </div>
        <div class="home-bed-construction">
          <div class="home-bed-construction-copy"><span class="home-kicker">FIVE WORKING LAYERS</span><h3>Five layers. Five clear jobs.</h3><p>Entry, pressure relief, stable support and tracking—each layer has a purpose.</p></div>
          ...
          <aside class="home-bed-proof" aria-label="Five WoafyPet Bed and Smart Base layers"><div><span aria-hidden="true">1</span><p><strong>Washable low-entry shell</strong>Easy step-in. Easy cleanup.</p></div><div><span aria-hidden="true">2</span><p><strong>Supportive bolsters</strong>Head, neck and hip support.</p></div><div><span aria-hidden="true">3</span><p><strong>Pressure-relief foam</strong>Cushions sensitive joints.</p></div><div><span aria-hidden="true">4</span><p><strong>Stable core</strong>Supports easier turning.</p></div><div><span aria-hidden="true">5</span><p><strong>Smart Base</strong>Tracks rest, movement, use and weight.</p></div></aside>
        </div>
      </section>

      <section class="home-contract-close" aria-label="Smart Base insights and care profile"><article class="home-contract-insights"><figure>${image("product-visualization-smart-base.png", "Verified dark WoafyPet Smart Base shown flat and folded for passive pattern tracking")}</figure><div><span class="home-kicker">EARLIER CHANGE SIGNALS</span><h2>Spot changes earlier.</h2><p>Smart Base learns your dog’s baseline and flags sustained shifts in four daily signals.</p><dl class="home-insight-metrics"><div><dt>Rest</dt><dd>Shorter or broken</dd></div><div><dt>Night movement</dt><dd>More restless</dd></div><div><dt>Bed use</dt><dd>Less frequent</dd></div><div><dt>Weight</dt><dd>Gain or loss</dd></div></dl><p class="home-insight-action"><strong>See the shift. Save it. Share it with your veterinarian.</strong></p><small>Pattern tracking—not diagnosis.</small><a href="/smart-base/">See how tracking works →</a></div></article><article class="home-contract-profile"><div><span aria-hidden="true">♡</span><p><strong>Build your dog’s care profile</strong>Add your dog once. Keep private lessons and health history together.</p></div><a href="/account/">Create my care profile →</a></article></section>
