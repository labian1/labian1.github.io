...
function wmHomePage() {
  ...
  return page({
    ...
    <div class="home-contract">
      ...
      <section class="home-contract-care-grid" aria-label="Veterinary evidence"><article class="home-contract-evidence"><figure>${image("vet-silvan-urfer.jpg", "Dr. Silvan Urfer, veterinarian and dog-aging researcher")}</figure><div><span class="home-kicker">VETERINARY EVIDENCE</span><h2>Care rooted in veterinary knowledge.</h2><p>Our guidance is shaped by veterinary expertise, so you can feel more confident in the next step you take.</p><a href="/find-care/?care=senior-veterinarians">Meet our veterinary advisors →</a></div></article></section>
      ...
      <section class="home-contract-bed" aria-labelledby="home-bed-title"><div class="home-contract-bed-copy"><span class="home-kicker">PREMIUM ORTHOPEDIC SUPPORT</span><h2 id="home-bed-title">Deep rest for stiff joints.</h2><p>Orthopedic support and a low front opening help senior dogs settle more comfortably and get up more easily.</p><a class="button primary" href="https://www.woafy.pet/">Explore Bed + Smart Base →</a></div><figure class="home-contract-product">${image("bed-layers.png", "Exploded WoafyPet orthopedic bed showing structured bolsters, removable cover, supportive foam layers and Smart Base")}</figure><aside class="home-bed-proof" aria-label="WoafyPet orthopedic bed results"><div><span aria-hidden="true">↘</span><p><strong>Low front entry</strong>Easier access for slower legs</p></div><div><span aria-hidden="true">♡</span><p><strong>Supportive bolsters</strong>Steady neck and hip support</p></div><div><span aria-hidden="true">▤</span><p><strong>Multi-layer foam</strong>Cushions pressure and supports joints</p></div><div><span aria-hidden="true">↻</span><p><strong>Removable cover</strong>Made for easier everyday care</p></div></aside></section>

      <section class="home-contract-close" aria-label="Smart Base insights and care profile"><article class="home-contract-insights"><figure>${image("product-visualization-smart-base.png", "Verified WoafyPet Smart Base shown flat beneath the bed and folded for storage")}</figure><div><span class="home-kicker">SMART BASE INSIGHTS</span><h2>Wellness insights that connect the dots.</h2><p>See patterns across rest, night movement, bed use and weight—so sustained changes are easier to share with your veterinarian.</p><dl class="home-insight-metrics"><div><dt>Rest</dt><dd>Duration</dd></div><div><dt>Night movement</dt><dd>Pattern</dd></div><div><dt>Bed use</dt><dd>Frequency</dd></div><div><dt>Weight</dt><dd>Trend</dd></div></dl><a href="/smart-base/">How Smart Base works →</a></div></article><article class="home-contract-profile"><div><span aria-hidden="true">♡</span><p><strong>Build your dog’s care profile</strong>Add your dog once. Keep private lessons and health history together.</p></div><a href="/account/">Create my care profile →</a></article></section>
