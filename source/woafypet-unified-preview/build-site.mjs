...
const lessons = [
    ...
    chapters: [
      {
        ...
        result:
          "You will know how much the bowl changes and what happens alongside it.",
  ...
  },
  {
    ...
    community: {
      question:
        "My dog's harness suddenly feels loose. How do I know if the weight change is real?",
      excerpt:
  ...
  },
  {
    ...
    community: {
      question:
        "My dog seems different after a new medicine. What should I write down before I call?",
      excerpt:
...
function legacyHeader() {
  return `<header class="site-header" data-header>
    ...
    <nav class="site-nav" id="site-navigation" aria-label="Primary navigation" data-site-nav>
      ...
      <a href="https://www.woafy.pet/">WoafyPet Bed</a>
...
function legacyFooter() {
  return `<footer class="site-footer">
    <div class="footer-top">
      ...
      <div><h2>WoafyPet Bed</h2><a href="https://www.woafy.pet/">Explore the Bed</a><a href="/smart-base/">Smart Base</a><a href="/smart-bed/">How it helps</a><a href="/about/">Our story</a></div>
    </div>
...
function legacyPage({ route, title, description, body, bodyClass = "" }) {
  const canonical = `https://www.woafy.pet${route}`;
  return `<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
function footer() {
  return `<footer class="wm-footer">
    <div class="wm-footer-grid">
      <div class="wm-footer-brand"><a class="wm-wordmark" data-logo-mark href="/" aria-label="WoafMeow home">${image("woafmeow-logo-coral.png", "WoafMeow", { eager: true })}</a><p>Learn, connect and find support—so your dog's senior years can thrive.</p><strong class="wm-footer-trust">Trusted by 10,000+ pet owners.</strong><nav class="wm-footer-socials" aria-label="WoafMeow social media"><a href="https://discord.gg/9wNjFp2dNX" target="_blank" rel="noreferrer">Discord</a><a href="http://instagram.com/woafy.pet" target="_blank" rel="noreferrer">Instagram</a><a href="https://www.facebook.com/share/g/1DfE2k8M5W/?mibextid=wwXIfr" target="_blank" rel="noreferrer">Facebook</a><a href="https://linkedin.com/company/woafmeow" target="_blank" rel="noreferrer">LinkedIn</a></nav></div>
      ...
      <div><h2>About</h2><a href="/about/">Our mission</a><a href="/about/">How we help</a><a href="/support/">FAQs</a></div>
    </div>
    <div class="wm-footer-bottom"><span>© 2026 WoafMeow</span><nav aria-label="Legal"><a href="/privacy/">Privacy</a><a href="/terms/">Terms</a><a href="/accessibility/">Accessibility</a></nav></div>
  </footer>`;
}
...
function wmHomePage() {
  ...
  return page({
    ...
    bodyClass: "home-v12 home-v13 home-v14 home-v15",
    body: `
    <div class="home-reference">
      ...
      <section class="home-care-hub" id="topics" aria-labelledby="home-care-hub-heading"><header><div><h2 id="home-care-hub-heading">Choose the change. Open a practical lesson.</h2><p>Real questions from dog owners, with veterinarian-supported steps you can use today.</p></div><a href="/care-circle/">Browse every Care Circle lesson →</a></header><div class="home-circle-grid">${publicLessons.map(([topic, title, copy, asset, href]) => `<a class="home-circle-card" href="${href}"><figure>${image(asset, `${topic.toLowerCase()} public Care Circle lesson`)}</figure><div><small>${topic}</small><h3>${title}</h3><p>${copy}</p><span>Read the complete lesson →</span></div></a>`).join("")}</div><footer><strong>Trusted by 10,000+ pet owners</strong><span>Six everyday care paths</span><span>Public examples with owner consent</span></footer></section>

      <section class="home-ref-guide"><div class="home-guide-intro"><span>Created with experienced veterinarian guidance</span><h2>The complete Senior Dog Care Guide—free.</h2><p>Turn changes in movement, sleep, appetite, water, bathroom habits and daily life into a clearer care plan.</p><ul><li>Six common change pathways</li><li>A seven-day observation plan</li><li>Call-sooner warning signs</li><li>A vet-ready summary template</li></ul></div><form data-preview-form data-guide-delivery data-submit-api="https://www.woafmeow.com/api/newsletter" data-success-message="The guide is on its way. Please check your inbox and spam folder." data-form-title="Senior Dog Care Guide"><input type="hidden" name="requestType" value="senior-dog-guide"><input type="hidden" name="guideUrl" value="https://labian1.github.io/guide/"><input type="hidden" name="consent" value="true"><label><span class="sr-only">Email address</span><input name="email" type="email" autocomplete="email" placeholder="Your email address" required></label><button class="button primary" type="submit">Send the veterinarian-supported guide →</button><p class="form-note" data-form-note role="status" aria-live="polite"></p></form><a class="home-guide-book" href="/guide/" aria-label="Explore the complete Senior Dog Care Guide"><span>The complete</span><strong>Senior Dog Care Guide</strong>${image("real-golden-forest.jpg", "Golden retriever on the cover of the Senior Dog Care Guide")}</a></section>
      ...
      <section class="home-ref-bed" aria-labelledby="home-bed-heading"><header><span>WoafyPet Smart Bed</span><h2 id="home-bed-heading">Premium comfort with joint-support and health alerts in real-time.</h2><p>One premium bed combines aging-joint support, easy daily care and passive wellness tracking.</p></header><div class="home-bed-grid">
        <article class="home-bed-story home-bed-comfort-story"><div class="home-bed-copy"><span>Premium orthopedic comfort</span><h3>Help stiff joints settle into deeper rest.</h3><p>The low front opening reduces the step into bed. Supportive bolsters and layered foam create a stable place to lean, turn and sleep.</p><ul class="home-bed-feature-list"><li><strong>Low entry</strong><span>Easier access for slower legs</span></li><li><strong>Supportive bolsters</strong><span>A steady edge for resting</span></li><li><strong>Elegant at home</strong><span>Furniture-grade neutral finish</span></li><li><strong>Easy maintenance</strong><span>Removable, washable cover</span></li></ul><a class="button primary" href="https://www.woafy.pet/">Explore the WoafyPet Smart Bed →</a></div><figure>${image("hero-bed.webp", "Golden retriever resting in the premium WoafyPet Smart Bed")}<figcaption>WoafyPet Smart Bed</figcaption></figure></article>
        <article class="home-bed-story home-bed-layer-story"><figure>${image("bed-layers.png", "Complete WoafyPet Smart Bed foam and Smart Base layer system")}</figure><div class="home-bed-copy"><span>Five purposeful layers</span><h3>Built for comfort, stability and easier cleaning.</h3><p>Every layer has a clear job—from the soft washable cover to pressure-relieving foam, orthopedic support, the Smart Base and a non-slip foundation.</p><ol class="home-bed-layer-list"><li><b>1</b><span><strong>Soft removable cover</strong>Machine-washable everyday care</span></li><li><b>2</b><span><strong>Comfort foam</strong>Relieves surface pressure</span></li><li><b>3</b><span><strong>Orthopedic support</strong>Stable, medical-grade foam</span></li><li><b>4</b><span><strong>Smart Base</strong>Passive rest and weight sensing</span></li><li><b>5</b><span><strong>Non-slip base</strong>Stays steady during entry</span></li></ol><a class="button secondary" href="https://www.woafy.pet/">See the complete bed →</a></div></article>
        <article class="home-bed-story home-bed-tracking-story"><div class="home-bed-copy"><span>Smart Base wellness insights</span><h3>Notice changes before they become the new normal.</h3><p>No collar and no camera. Smart Base quietly summarizes the patterns that are hardest to see from one day to the next.</p><div class="home-bed-metrics"><span><b>Rest duration</b>See whether total rest is shifting</span><span><b>Night movement</b>Notice wake-ups and repositioning</span><span><b>Bed use</b>Spot avoidance of a familiar rest place</span><span><b>Weight trends</b>Add longer-term context for your care team</span></div><a class="button primary" href="https://www.woafy.pet/">See how Smart Base works →</a></div><figure>${image("product-visualization-smart-base.png", "WoafyPet Smart Base product visualization and wellness insight system")}<figcaption>Product visualization</figcaption></figure></article>
      </div></section>
...
function wmLearnPage() {
  return page({
    ...
    body: `<section class="unified-forward-card"><h1>Care lessons now live inside Care Circle.</h1><p>Browse every public question, pet profile and complete lesson in one place.</p>${button("Open Care Circle", "/care-circle/")}</section>`,
  });
}
...
function wmCareCirclePage() {
  ...
  return page({
    ...
    bodyClass: "circle-v7 circle-v8 circle-v9",
    body: `
    <section class="circle-hero-v7" id="ask"><div><h1>Real questions. Answers shaped around each dog.</h1><p>See the dog’s age, breed, owner-shared conditions and exact change—then open four detailed, veterinarian-supported parts tailored to that dog.</p><form class="circle-question-form circle-hero-question" data-account-ask-form><div><h2>What changed with your dog?</h2><p data-active-pet-summary></p></div><label><span>Describe the change</span><textarea name="question" maxlength="500" required placeholder="What happened, when did it start, and which routine is harder?"></textarea></label><label class="question-image-field"><span>Add a photo of your dog <em>(optional, strongly recommended)</em></span><input type="file" name="questionImage" accept="image/jpeg,image/png,image/webp" data-question-image-input><small>A current photo can appear with the public lesson when you consent.</small><img data-question-image-preview hidden alt="Question photo preview"><button type="button" class="text-button" data-question-image-remove hidden>Remove photo</button></label><label class="consent-row"><input type="checkbox" name="publicPetDetails" required><span>Show this dog’s age, breed, owner-shared conditions and optional photo with the public question.</span></label><button class="button primary" type="submit">Build and publish my four-part care lesson →</button><p class="form-note" data-account-ask-note role="status" aria-live="polite"></p></form><div class="circle-account-gate" data-account-gate><div><h2>Start with your dog’s care profile.</h2><p>Add age, breed, conditions, medicines and a profile photo once. Your question will be carried into the one-time profile step.</p></div><a class="button secondary" href="/account/?next=ask">Create or edit my care profile →</a></div><div class="circle-hero-actions"><a class="button secondary" href="#public-lessons">Browse public lessons →</a></div></div><figure>${image("real-care-circle-owner-dog.jpg", "Real dog owner sharing a close moment with her dog", { eager: true })}</figure></section>
...
function wmLessonPage(lesson) {
  ...
  const fourthChapterMap = {
    "slower-after-rest": {
      title: "Prepare a mobility summary your veterinarian can use",
  ...
  const mobilitySupport = mobilityRelated
    ? `<section class="mobility-bed-path"><div class="wm-wrap"><div><span>Supportive rest between active-care steps</span><h2>Make getting in, settling and rising easier.</h2><p>A low entry, supportive bolsters and layered orthopedic foam can reduce everyday friction for a dog who hesitates after rest. WoafyPet Smart Bed also tracks passive rest, bed-use and weight trends that can add useful context for your care team. It does not diagnose or replace veterinary evaluation.</p><ul><li>Low front entry for slower legs</li><li>Layered joint-support foam</li><li>Removable, washable cover</li><li>Passive rest and wellness trends</li></ul><a class="button primary" href="https://www.woafy.pet/">Explore the WoafyPet Smart Bed →</a></div><figure>${image("hero-bed.webp", "WoafyPet Smart Bed supporting a resting senior dog")}</figure></div></section>`
    : "";
  return page({
    ...
    <div class="lesson-chapters-v7">${lessonChapters.map((chapter, index) => `<section id="chapter-${index + 1}" data-lesson-chapter="${index + 1}" data-tailored-part="${index + 1}"><div class="wm-wrap lesson-chapter-layout"><figure>${image(imgs[index], `${chapter.title} for ${lesson.title}`)}</figure><div><h2>${escapeHtml(chapter.title)}</h2><aside class="tailored-context"><strong>Why this matters for <span data-tailored-pet-name>${escapeHtml(profile[0])}</span></strong><p data-tailored-context>${escapeHtml(profile[0])} is ${escapeHtml(profile[1])}, a ${escapeHtml(profile[2])}, with ${escapeHtml(profile[3])}; the owner reports ${escapeHtml(profile[4])}. This chapter prioritizes the safest observation and next step for that exact pattern.</p></aside><p class="chapter-result" data-tailored-chapter-summary="${index + 1}">${escapeHtml(chapter.result)}</p><p>${escapeHtml(chapter.copy)}</p><ol data-tailored-chapter-steps="${index + 1}">${chapter.steps.map((step) => `<li>${escapeHtml(step)}</li>`).join("")}</ol><fieldset class="chapter-quiz" data-chapter-quiz data-answer="${escapeHtml(chapter.quiz.answer)}" data-correct-message="${escapeHtml(chapter.quiz.correct)}" data-retry-message="${escapeHtml(chapter.quiz.retry)}"><legend>${escapeHtml(chapter.quiz.question)}</legend>${chapter.quiz.options.map(([value, label]) => `<label><input type="radio" name="${lesson.slug}-quiz-${index + 1}" value="${escapeHtml(value)}"><span>${escapeHtml(label)}</span></label>`).join("")}<button type="button" data-check-quiz>Check answer</button><p role="status" aria-live="polite" data-quiz-feedback></p></fieldset></div></div></section>`).join("")}</div>${mobilitySupport}<section class="call-sooner-v7"><div class="wm-wrap"><h2>Call sooner when you see this</h2><p>${escapeHtml(lesson.urgent)}</p>${button("Find care now", "/find-care/")}</div></section></article>`,
  });
}
...
function wmLegacyLessonPage(lesson) {
  ...
  const html = page({
    ...
    body: `<section class="unified-forward-card"><h1>This lesson is now in Care Circle.</h1><p>Public questions, pet profiles and complete lessons live together.</p>${button("Open the lesson", destination)}</section><script>location.replace(${JSON.stringify(destination)});</script>`,
  });
  return html.replace(
    "</head>",
...
function wmFindCarePage() {
  ...
  return page({
    ...
    body: `
    <section class="directory-hero-v6"><div><h1>Find a real care team—and know the next call to make.</h1><p>Choose the kind of help and your region. Each listing opens a provider-published profile or official professional directory.</p><div class="directory-selectors" data-directory-controls><label><span>Care type</span><select data-directory-category>${careTypes.map(([value, label]) => `<option value="${value}">${label}</option>`).join("")}</select></label><label><span>State or region</span><select data-directory-region><option value="all">All states and regions</option>${regions.map((region) => `<option value="${escapeHtml(region)}">${escapeHtml(region)}</option>`).join("")}</select></label></div></div><figure>${image("guide-vet-care-brown-dog.jpg", "Real dog receiving attentive veterinary care", { eager: true })}</figure></section>
...
function wmPetLossPage() {
  ...
  return page({
    ...
    <section class="loss-first-days"><div class="wm-wrap"><header><h2>What helps in the first days after loss.</h2><p>Grief changes by the hour. Use the part that helps; leave the rest for later.</p></header><div><article><figure>${image("real-golden-forest.jpg", "Golden retriever remembered during the first days after loss")}</figure><h3>Protect the first 24 hours</h3><p>Choose one person for calls and messages. Eat something simple, drink water, and postpone decisions that do not need an answer today.</p></article><article><figure>${image("real-holding-dog.jpg", "A caregiver holding a beloved dog close")}</figure><h3>Help children and other pets</h3><p>Use clear words, keep familiar routines where possible, and allow every family member—including other animals—to respond differently.</p></article><article><figure>${image("real-memorial-tree-planting.jpg", "Hands planting a living memorial tree")}</figure><h3>Keep what feels like them</h3><p>Save the collar, a paw print, one photograph, a voice note or the story everyone tells. There is no deadline for deciding what stays.</p></article></div></div></section>
...
function wmSmartBasePage() {
  return page({
    ...
    bodyClass: "base-v6",
    body: `
    <section class="base-hero-v6"><div><span>WoafyPet Smart Base</span><h1>Notice routine changes without putting another device on your dog.</h1><p>The sensing layer sits beneath the bed and turns repeated use into a calmer weekly view.</p>${button("Explore the complete bed", "/smart-bed/")}</div><figure>${image("product-visualization-smart-base.png", "WoafyPet Smart Base product visualization", { eager: true })}</figure></section>
...
function wmAboutPage() {
  return page({
    ...
    bodyClass: "about-v6",
    body: `
    <section class="story-hero-v6"><figure>${image("bobby.jpg", "Bobby, Robert's Alaskan Malamute", { eager: true })}</figure><div><h1>The quiet changes were easy to explain away.</h1><p>Bobby was Robert's Alaskan Malamute—a loved family dog, never a case study. His slower rises, longer recovery and preference for the cool floor made one thing clear: families need better language for the changes they feel before they can name.</p></div></section>
    <section class="story-body-v6"><div class="reading-width"><p class="drop-cap">At first, each change felt too small to stop the day over. Bobby still greeted his people, enjoyed a bright afternoon and found his familiar way of asking to be close.</p><p>But taken together, the moments told a story. Comfort mattered. So did a calmer record of what was changing, when it happened and what made the day easier.</p><blockquote>WoafMeow exists to help families feel seen, understand the pattern and reach the right next step with less fear.</blockquote><p>WoafyPet grew from the same lesson: a bed should support the body first, while quiet technology helps the family notice repeated change without pretending to diagnose it.</p></div></section>
    <section class="story-mission-v7"><div class="wm-wrap"><header><h2>What WoafMeow is here to change.</h2><p>Families should not have to choose between a frightening search result and a vague reassurance when a dog’s daily life begins to change.</p></header><div><article><h3>Understand the change</h3><p>Turn a concern into a clear observation, a practical lesson and a better question for the care team.</p></article><article><h3>Find the right people</h3><p>Connect families with veterinary care, specialist resources and another owner who understands the same daily challenge.</p></article><article><h3>Honor the whole bond</h3><p>Support families through comfort decisions, grief and living memorials without turning loss into product pressure.</p></article></div></div></section>
    <section class="story-build-v7"><div class="wm-wrap"><figure>${image("real-senior-care-at-home.jpg", "Older dog receiving attentive daily care at home")}</figure><div><h2>From one dog’s story to a practical care ecosystem.</h2><p>WoafMeow brings together public Care Circle lessons, personalized questions, the Senior Dog Care Guide, Find Care, Wednesday owner introductions, pet-loss support and memorial trees.</p><p>WoafyPet builds the physical layer: supportive rest first, with quiet pattern tracking designed to help families notice meaningful change sooner.</p><a class="button secondary" href="/care-circle/">Explore Care Circle →</a></div></div></section>
    <section class="story-values"><div class="wm-wrap"><article><h2>Care before commerce</h2><p>Education, grief support and human connection do not become product pressure.</p></article><article><h2>Specific before dramatic</h2><p>Useful observations and honest limits build more trust than alarming claims.</p></article><article><h2>Human before automated</h2><p>Technology should make a family calmer and more prepared—not more afraid.</p></article></div></section>`,
  });
}
...
function wmSupportPage() {
  return page({
    ...
    title: "Support",
    description:
      "Find the right WoafMeow route for care lessons, professional support, introductions, memorials and product questions.",
    bodyClass: "support-v6",
    body: `
    <section class="support-hero-v6"><div><h1>Tell us what you need help with.</h1><p>Choose the route that fits today.</p></div><figure>${image("real-holding-dog.jpg", "Caregiver holding a dog close", { eager: true })}</figure></section>
    <section class="support-routes-v6"><div class="wm-wrap"><a href="/care-circle/"><h2>Understand a change</h2><p>Open a public Care Circle lesson.</p></a><a href="/find-care/"><h2>Find professional care</h2><p>Search providers and official directories.</p></a><a href="/wednesday-introductions/"><h2>Meet someone who understands</h2><p>Request an offline owner introduction.</p></a><a href="/pet-loss-support/"><h2>Navigate pet loss</h2><p>Take the next step at your pace.</p></a><a href="/memorial-tree/"><h2>Create a memorial</h2><p>Plant a living tribute.</p></a><a href="https://www.woafy.pet/"><h2>Explore WoafyPet</h2><p>Learn about the Smart Bed and Smart Base.</p></a></div></section>
    <section class="support-expect-v7"><div class="wm-wrap"><div><h2>What happens after you contact us?</h2><ol><li><span>1</span><p>We read the full request and route it to the right WoafMeow workflow.</p></li><li><span>2</span><p>You receive a direct response at the email you shared.</p></li><li><span>3</span><p>If another professional is the better next step, we point you to the relevant care path.</p></li></ol></div><figure>${image("real-companion-moment.jpg", "A dog and caregivers spending time together outdoors")}</figure></div></section>
    <section class="support-faq-v7"><div class="wm-wrap"><h2>Common questions</h2><details><summary>Where is my Senior Dog Care Guide?</summary><p>After submitting your email, check the inbox and spam folder for the delivery message. If it does not arrive, contact us below with the same email address.</p></details><details><summary>How do I update my dog’s profile?</summary><p>Open My profile from the navigation, choose Edit profile, update the details and save.</p></details><details><summary>How does Care Circle use my dog’s information?</summary><p>Age, breed, owner-shared conditions, medicines and the exact change help focus the lesson. You choose whether those pet details appear with a public question.</p></details><details><summary>How do Wednesday introductions work?</summary><p>Requests are reviewed each Wednesday. When there is a suitable fit, both owners decide whether to exchange contact details.</p></details><details><summary>What does a memorial-tree request include?</summary><p>You share your dog’s name and one memory. The tribute supports Friends of Usambara’s community planting work and includes a memorial confirmation.</p></details></div></section>
    <section class="support-contact-v6"><div class="wm-wrap"><div><h2>Contact WoafMeow</h2><p>Tell us what happened, what you have already tried and what a useful answer would help you do next.</p></div><form class="preview-form" data-preview-form data-submit-api="https://www.woafmeow.com/api/contact" data-success-message="Your message is with the WoafMeow team." data-form-title="WoafMeow support"><div class="form-grid"><label><span>Name</span><input name="name" autocomplete="name" required></label><label><span>Email</span><input name="email" type="email" autocomplete="email" required></label><label class="field-wide"><span>What do you need?</span><select name="topic" required><option value="">Choose one</option><option value="care-circle">Care lessons or guide</option><option value="directory">Find Care</option><option value="wednesday-match">Wednesday introductions</option><option value="other">Pet loss support</option><option value="memorial-tree">Memorial tree</option><option value="other">WoafyPet product</option><option value="other">Other</option></select></label><label class="field-wide"><span>Message</span><textarea name="message" required minlength="12" maxlength="1200"></textarea></label></div><label class="consent-row"><input type="checkbox" name="consent" required><span>WoafMeow may use these details to answer my request.</span></label><button class="button primary" type="submit">Send message →</button><p class="form-note" data-form-note role="status" aria-live="polite"></p></form></div></section>`,
  });
}
