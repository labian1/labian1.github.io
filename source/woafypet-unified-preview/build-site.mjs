...
const BACKEND_ORIGIN = "https://woafypet-senior-care.pages.dev";
    ...
    <div class="home-contract">
      ...
      <section class="home-contract-bed" aria-labelledby="home-bed-title">
        <div class="home-bed-system">
          <div class="home-contract-bed-copy"><span class="home-kicker">ORTHOPEDIC BED + SMART BASE</span><h2 id="home-bed-title">Ultra-premium rest. Earlier alerts.</h2><p class="home-bed-lead">A low-entry orthopedic bed built for deeper rest. Smart Base flags sustained changes worth sharing with your veterinarian.</p><ul class="home-bed-results"><li><strong>Inviting comfort</strong><span>Supportive bolsters and pressure-relief foam.</span></li><li><strong>Easy daily care</strong><span>Machine-washable, scratch-resistant cover.</span></li><li><strong>Earlier alerts</strong><span>Know when rest, movement, bed use or weight changes.</span></li></ul><a class="button primary" href="https://www.woafy.pet/">Explore Bed + Smart Base →</a></div>
        ...
        <div class="home-bed-construction">
          <div class="home-bed-construction-copy"><span class="home-kicker">ULTRA-PREMIUM ORTHOPEDIC COMFORT</span><h3>The bed dogs want to rest in.</h3><p>Pressure-relieving comfort, stable support and a removable machine-washable, scratch-resistant cover.</p></div>
          <figure class="home-contract-product">${image("bed-layers.png", "Exploded WoafyPet orthopedic bed and Smart Base construction")}</figure>
          <aside class="home-bed-proof" aria-label="WoafyPet Bed and Smart Base benefits"><div><p><strong>Low-entry washable shell</strong>Easier step-in and cleanup.</p></div><div><p><strong>Supportive bolsters</strong>Comfort for the head, neck and hips.</p></div><div><p><strong>Pressure-relief foam</strong>Cushions sensitive joints.</p></div><div><p><strong>Stable orthopedic core</strong>Supports easier turning.</p></div><div><p><strong>Smart Base</strong>Works under WoafyPet or an existing bed.</p></div></aside>
        </div>
      </section>

      <section class="home-contract-close" aria-label="Smart Base insights and care profile"><article class="home-contract-insights"><figure>${image("product-visualization-smart-base.png", "Verified dark WoafyPet Smart Base shown flat and folded for use beneath a dog bed")}</figure><div><span class="home-kicker">EARLIER HEALTH-CHANGE ALERTS</span><h2>Detect meaningful changes earlier.</h2><p>Place Smart Base beneath the WoafyPet Bed or almost any existing dog bed. It learns your dog’s normal pattern and alerts you when a change lasts.</p><dl class="home-insight-metrics"><div><dt>Rest</dt><dd>Shorter or broken</dd></div><div><dt>Night movement</dt><dd>More restless</dd></div><div><dt>Bed use</dt><dd>Less frequent</dd></div><div><dt>Weight</dt><dd>Gain or loss</dd></div></dl><p class="home-insight-action"><strong>Get the alert. Save the pattern. Share it with your veterinarian.</strong></p><small>Flags sustained changes. It does not diagnose a condition.</small><a href="/smart-base/">See how early alerts work →</a></div></article><article class="home-contract-profile"><div><span aria-hidden="true">♡</span><p><strong>Build your dog’s care profile</strong>Add your dog once. Keep private lessons and health history together.</p></div><a href="/account/">Create my care profile →</a></article></section>
